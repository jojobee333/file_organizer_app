...
class BaseRoute:
    ...
    @staticmethod
    async def get_items(session, model, id_: int):
        # OK
    ...
    @staticmethod
    async def get_by_id(session, model, id_: int):
        # OK
        query = select(model).where(model.id == id_)
        result = await session.execute(query)
    ...
    @staticmethod
    async def update(session, model, id_: int, **kwargs):
        # OK
        query = select(model).where(model.id == id_)
        result = await session.execute(query)
        instance = result.scalars().first()
    ...
    @staticmethod
    async def delete(session, model, id_: int):
        # OK
        query = select(model).where(model.id == id_)
        result = await session.execute(query)
        instance = result.scalars().first()
